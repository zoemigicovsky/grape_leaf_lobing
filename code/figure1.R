...
#Pasting the leaf shape diagram twice just so I have room for the landmark schematic 
pdf("figures/figure1_1.pdf", width=6, height=5)
ggarrange(p1, ncol=1, widths=c(3), labels="AUTO")
dev.off()

pdf("figures/figure1_2.pdf", width=6, height=3)
ggarrange(p2,p2, ncol=2, widths=c(1.5,1.5), labels="AUTO")
dev.off()
